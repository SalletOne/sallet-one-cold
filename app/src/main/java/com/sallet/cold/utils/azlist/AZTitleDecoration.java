package com.sallet.cold.utils.azlist;
...
import com.sallet.cold.utils.TextDrawUtils;
...
public class AZTitleDecoration extends RecyclerView.ItemDecoration {
	...
	public static class TitleAttributes {
		...
		public TitleAttributes(Context context) {
			...
			mTextSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 11, context.getResources().getDisplayMetrics());
			mTextColor = Color.parseColor("#FF000000");
			mBackgroundColor = Color.parseColor("#f7f7f7");
		}
